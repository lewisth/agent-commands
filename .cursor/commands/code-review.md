...
- Review frontend changes for suitability for desktop and tablet screen sizes (including iPad Mini and 4K screens).
...
- If i18n is set up, are the added strings localized and new routes internationalized?
