Review all code:
- Are there quality tests for each project? Prefer fewer, high-quality tests. Prefer integration tests for user flows.
- Are all major components and functionality of the solution covered in the tests?
- If it is a C#/.NET project, use xUnit, NSubstitute, and Shouldly.
